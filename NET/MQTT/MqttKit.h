...
typedef struct Buffer
{
	...
	uint8	_memFlag;	// 内存使用的方式：0-未申请  1-使用的动态内存   2-使用的固定内存
...
enum MqttPacketType
{
    ...
    MQTT_PKT_PUBREC,      /**< 发布消息已接收数据包(Qos 2时回复MQTT_PKT_PUBLISH) */
    MQTT_PKT_PUBREL,      /**< 发布消息释放数据包(Qos 2时回复MQTT_PKT_PUBREC) */
    MQTT_PKT_PUBCOMP,     /**< 发布消息完成数据包(Qos 2时回复MQTT_PKT_PUBREL) */
...
enum MqttQosLevel
{
    ...
    MQTT_QOS_LEVEL0,  /**< 最多发一次 */
    MQTT_QOS_LEVEL1,  /**< 至少发一次  */
    MQTT_QOS_LEVEL2   /**< 只发一次 */
